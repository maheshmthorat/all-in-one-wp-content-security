...
* Description: Plugin for configuring Content Security for your site. Blocks different keyboard events and image dragging from users, also disabling browser console and inspect element in frontend visitors
* Version: 0.2
...
define('AOWPCS_PLUGIN_VERSION', '0.1');
